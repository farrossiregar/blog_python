...
class Articles(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    title = models.CharField(db_column='title', max_length=35)  # Field name made lowercase.
    introtext = models.CharField(db_column='introtext', max_length=35)  # Field name made lowercase.
    subtitle = models.CharField(db_column='subtitle', max_length=35)  # Field name made lowercase.
    foto_name = models.CharField(db_column='foto_name', max_length=35)  # Field name made lowercase.
    publish_date = models.CharField(db_column='publish_date', max_length=35)  # Field name made lowercase.
    livereport = models.CharField(db_column='livereport', max_length=35)  # Field name made lowercase.
    class Meta:
        managed = False
        db_table = 'articles'
